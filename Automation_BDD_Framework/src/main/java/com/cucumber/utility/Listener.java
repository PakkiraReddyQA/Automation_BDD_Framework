...
//		logger = extent.createTest(itestfail.getName());
//		String screenshotPath = captureScreenshot(itestfail.getName());
//        logger.log(Status.FAIL, "Test Case Failed: " + itestfail.getName());
