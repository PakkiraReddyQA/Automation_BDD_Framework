...
public class CommonBean {
	...
	public static ArrayList<String> collection=new ArrayList<>();
	public static ArrayList<String> collectionAPI=new ArrayList<>();
	...
	public static List<Integer> postKey=new ArrayList<>();
