...
@Test:Insistute001 @TestName:InsistuteFilter @InsistuteFilter
  Scenario Outline: Verify the Filter Criteria in Institutions
    ...
    Examples: 
      ...
      | TC_ADMS_UM_001 | SISQA.xlsx	 | Institution |Administrator  |
...
#    Then Store all results UI "TestCaseName"
    Examples: 
      | TC_ID     	   | FileName              | Sheetname   |role |
      | TC_ADMS_UM_002 | ResponcesiveEdQA.xlsx | Institution |Administrator  |
  ...
  Scenario Outline: Validate the insistute as InActive  
   ...
   Examples: 
      | TC_ID     	   | FileName              | Sheetname   |role |
      | TC_ADMS_SY_001 | ResponcesiveEdQA.xlsx | SchoolYear  |Administrator  |
